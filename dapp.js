...
function showAuthUI() {
    ...
    $('#auth-nav-links').style.display = 'flex'; 
    // Hide Logout in navbar
    $('#logged-in-nav-links').classList.add('d-none');
    $('#logged-in-nav-links').style.display = 'none'; 
...
async function showDashboardUI(u) {
    ...
    $('#auth-nav-links').style.display = 'none'; 
    // Show Logout in navbar
    $('#logged-in-nav-links').classList.remove('d-none');
    $('#logged-in-nav-links').style.display = 'flex'; 
